...
//       // Save authentication data if your backend returns it
...
//             Sign in to continue your journey with Interxora.ai.
//           </p>
//         </div>
...
//               required
//               className="w-full rounded-xl border border-blue-500/30 bg-blue-950/40 px-4 py-3 text-white placeholder-slate-500 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
//             />
//           </div>
...
//                 required
//                 className="w-full rounded-xl border border-blue-500/30 bg-blue-950/40 px-4 py-3 pr-16 text-white placeholder-slate-500 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20"
//               />
...
//         <button
//           type="button"
//           className="flex cursor-pointer w-full items-center justify-center gap-3 rounded-xl border border-slate-700 bg-slate-900/60 px-4 py-3 font-medium text-slate-200 transition hover:border-slate-500 hover:bg-slate-800"
//           onClick={() => {
